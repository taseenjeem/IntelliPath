      ...
      <div className="md:flex md:items-end md:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-6">
            ...
            companies. Whether you're looking to enhance your skills or share
            your expertise, IntelliPath is the trusted platform to achieve your
            goals. Partner with us and see how our courses are making a
